...
const StudentForm = () => {
    ...
    return (
        <div className="">
            ...
            {/* update Form */}
            {/* {show && (
                <div className="bg-black/80 w-full inset-0">
                    <div className="z-50 absolute">
                        <form className="w-fit p-5 border rounded-lg flex flex-col gap-2 " onSubmit={(e) => isEdit ? UpdateForm(e) : AddFrom(e)}>
                            ...
                            <button type="submit" className="bg-blue-500 mt-2 text-white p-2 rounded-lg cursor-pointer ">{isEdit ? "Update" : "Register"}</button>
                ...
                view && viewData && (
                    <div className="flex justify-center items-center inset-0 absolute top-20 left-20 ">
                        <div className="bg-blue-500 p-6 relative rounded-lg text-center text-white">
                            <p className=" absolute top-1 right-1" onClick={() => setView(false)}><img src={close} /></p>
