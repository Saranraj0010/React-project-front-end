...
const AdmissionDetails = () => {
    ...
    const filterData = student.filter((item) => {
        ...
        return (
            ...
            (filter.filterText === "" || name.toLowerCase().includes(filter.filterText.toLowerCase()))
        );
    });
    const OnEdit = (id) => {
    ...
    return (
        <div className="min-h-screen px-2">
            ...
            <div className="bg-white my-5 shadow-2xl rounded-2xl grid grid-cols-2 md:flex justify-end gap-3 items-center p-4">
